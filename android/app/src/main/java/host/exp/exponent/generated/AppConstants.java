...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@gregastley/expo-template-bare";
  public static final String SHELL_APP_SCHEME = "expc8f93d5d53dd472d88e158b81e1f3d7f";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@gregastley/expo-template-bare", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40gregastley%2Fexpo-template-bare%2F1.0.0%2F7db798820e2b02160f11dbbd81f7bb51-35.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
